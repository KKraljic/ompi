...
extern bool  ompi_coll_offloaded_use_dynamic_rules;
extern char* ompi_coll_offloaded_dynamic_rules_filename;
extern int   ompi_coll_offloaded_init_tree_fanout;
extern int   ompi_coll_offloaded_init_chain_fanout;
extern int   ompi_coll_offloaded_init_max_requests;
extern int   ompi_coll_offloaded_alltoall_small_msg;
extern int   ompi_coll_offloaded_alltoall_intermediate_msg;
...
struct coll_offloaded_force_algorithm_mca_param_indices_t {
...
typedef struct coll_offloaded_force_algorithm_mca_param_indices_t coll_offloaded_force_algorithm_mca_param_indices_t;


/* the following type is for storing actual value obtained from the MCA on each offloaded module */
/* via their mca param indices lookup in the component */
/* this structure is stored once per collective type per communicator... */
struct coll_offloaded_force_algorithm_params_t {
...
typedef struct coll_offloaded_force_algorithm_params_t coll_offloaded_force_algorithm_params_t;

/* the indices to the MCA params so that modules can look them up at open / comm create time  */
extern coll_offloaded_force_algorithm_mca_param_indices_t ompi_coll_offloaded_forced_params[COLLCOUNT];
/* the actual max algorithm values (readonly), loaded at component open */
extern int ompi_coll_offloaded_forced_max_algorithms[COLLCOUNT];
...
/* All Reduce */
int ompi_coll_offloaded_allreduce_intra_dec_fixed(ALLREDUCE_ARGS);
int ompi_coll_offloaded_allreduce_intra_dec_dynamic(ALLREDUCE_ARGS);
int ompi_coll_offloaded_allreduce_intra_do_this(ALLREDUCE_ARGS, int algorithm, int faninout, int segsize);
...
/* Reduce */
int ompi_coll_offloaded_reduce_intra_dec_fixed(REDUCE_ARGS);
int ompi_coll_offloaded_reduce_intra_dec_dynamic(REDUCE_ARGS);
int ompi_coll_offloaded_reduce_intra_do_this(REDUCE_ARGS, int algorithm, int faninout, int segsize, int max_oustanding_reqs);
...
struct mca_coll_offloaded_module_t {
    ...
    coll_offloaded_force_algorithm_params_t user_forced[COLLCOUNT];
