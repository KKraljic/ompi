...
#ifndef MCA_COLL_offloaded_DYNAMIC_RULES_H_HAS_BEEN_INCLUDED
#define MCA_COLL_offloaded_DYNAMIC_RULES_H_HAS_BEEN_INCLUDED
...
/* free alloced memory routines, used by file and offloaded component/module */
...
int ompi_coll_offloaded_get_target_method_params (ompi_coll_com_rule_t* base_com_rule, size_t mpi_msgsize,
                                              int* result_topo_faninout, int* result_segsize,
                                              int* max_requests);


END_C_DECLS
#endif /* MCA_COLL_offloaded_DYNAMIC_RULES_H_HAS_BEEN_INCLUDED */
